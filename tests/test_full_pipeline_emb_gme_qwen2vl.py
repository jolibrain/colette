#!/usr/bin/env python3
"""
Run a minimal end-to-end pipeline using the colette Python API with
Alibaba-NLP/gme-Qwen2-VL-2B-Instruct embedding to verify compatibility.
...
def main():
    ...
    logger = logging.getLogger('pipeline_debug_qwen2vl')
    ...
    logger.info('Starting pipeline smoke test (gme-Qwen2-VL)')
    ...
    app_name = 'ci_test_app_gme_qwen2vl'
    ...
    try:
        index_config['parameters']['input']['rag']['embedding_model'] = 'Alibaba-NLP/gme-Qwen2-VL-2B-Instruct'
    except Exception:
        pass
